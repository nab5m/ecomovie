...
public class MovieControllerDocs {
    ...
    @Parameters({
            ...
            @Parameter(name = "request", description = "<table>\n" +
                    "  <tr>\n" +
                    "    <th>필드 이름</th>\n" +
                    "    <th>타입</th>\n" +
                    "    <th>설명</th>\n" +
                    ...
                    "    <td>&nbsp;String&nbsp;</td>\n" +
                    "    <td>\n" +
                    "      &nbsp;&nbsp;파파고 API 무료 사용량 제한으로 인해 미구현 상태입니다.\n" +
                    "    </td>\n" +
                    "  </tr>\n" +
                    "  <tr>\n" +
                    "    <td>&nbsp;page&nbsp;</td>\n" +
                    "    <td>&nbsp;Integer&nbsp;</td>\n" +
                    "    <td>\n" +
                    "      &nbsp;&nbsp;페이지 번호는 1부터 total_pages까지 입력해주시면 됩니다.\n" +
                    "    </td>\n" +
                    "  </tr>\n" +
                    "</table>",
                    examples={
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "추천 영화 목록 조회 성공 (자료형 확인 가능)",
                    content = @Content(schema = @Schema(implementation = MovieRecommendationResponseDTO.class))),
            @ApiResponse(responseCode = "200 ", description = "추천 영화 목록 조회 성공 (예시 1)",
                    content = @Content(schema = @Schema(example = "{\n" +
                            "  \"page\": 1,\n" +
                            "  \"results\": [\n" +
                            "    {\n" +
