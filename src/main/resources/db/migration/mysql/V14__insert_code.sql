...
SELECT @CODE_CATEGORY_CONTENT_TYPE_ID := code_category_id FROM `code_category`
...
SELECT @CODE_CATEGORY_GENRE_ID := code_category_id FROM `code_category`
...
SELECT @CODE_CATEGORY_RELEASE_STATUS_ID := code_category_id FROM `code_category`
